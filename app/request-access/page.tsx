...
export default function RequestAccessPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // TODO: Implement API call to send access request
      ...
      <div className="flex items-center justify-center min-h-screen p-8 bg-gradient-to-br from-primary-500 to-purple-600">
        <div className="bg-white rounded-xl shadow-2xl p-12 w-full max-w-md">
          <div className="text-center py-8">
            ...
            <Link
              href="/"
              className="inline-block px-8 py-3.5 bg-gradient-to-r from-primary-500 to-purple-600 text-white rounded-lg font-semibold text-base transition-all hover:-translate-y-0.5 hover:shadow-lg"
            >
              Return to Home
            </Link>
          </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            <textarea
              ...
              rows={4}
              disabled={loading}
              className="px-4 py-3 border-2 border-gray-200 rounded-lg text-base transition-all focus:border-primary-500 focus:outline-none focus:ring-3 focus:ring-primary-100 disabled:bg-gray-100 disabled:cursor-not-allowed resize-y font-inherit"
            />
          </div>
